...
```json
"features": {
    "ghcr.io/GEBIT/devcontainer-firewall/firewall:0": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/GEBIT/devcontainer-firewall/blob/main/src/firewall/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
